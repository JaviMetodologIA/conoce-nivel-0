(function(){'use strict';
  ...
  function syncPromptDisclosure(details){
    ...
    summary.setAttribute('aria-label',action+(title&&title.textContent.trim()?' · '+title.textContent.trim():''));
  }
